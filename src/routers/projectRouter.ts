...
router.post("/update-project/:id", authMiddleware, projectController.updateProject);
router.post("/delete-project/:id", authMiddleware, projectController.deleteProject);
